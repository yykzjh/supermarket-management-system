  ...
  data() {
    return {
      ...
      form: {
        id: 6,
        name: '超级大汉堡',
        iconImage: 'https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png',
        // region: 'A1',
  ...
  methods: {
    ...
    async GetGoodDetails() {
      ...
      if(ret.StatusCode == 400) {
        ...
        // require("C:/Users/syc/Pictures/0470140004.jpg")
      }
      if(ret.good.icon!=null) {
        this.form.iconImage = 'http://localhost:8080/static/img/' + ret.good.icon
        console.log(this.form.iconImage)
      }
      //https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png// '
        else
      this.form.iconImage = 'http://localhost:8080/static/img/0470140004.jpg'//'https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png'
    },
    async GetLineData() {
